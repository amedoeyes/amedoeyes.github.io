	...
	return (
		<Section id="about" title="About">
			<p className="m-auto max-w-3xl">
				...
				development, I&apos;m constantly learning new concepts and
				technologies, and my goal is to make a positive impact on the
				world.
				<br />
				<br />I use Arch Linux (BTW) and Neovim. And I love cats.
			</p>
		</Section>
	);
}
