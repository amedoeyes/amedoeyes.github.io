...
{
	if (region.O.D === region.W.D)
	{
		return 'on line ' + region.O.D;
	}
	return 'on lines ' + region.O.D + ' through ' + region.W.D;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aN, request.a_, true);
		} catch (e) {
...
var $author$project$Main$FocusInput = {$: 2};
		...
		_List_fromArray(
			[
				...
				A3(
					...
					F2(
						function (ctrl, meta) {
							return (ctrl || meta) ? $author$project$Main$NoOp : $author$project$Main$FocusInput;
						}),
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aB: false, aD: r.aD, aH: r.aH, Z: r.Z, aN: r.aN, aX: r.aX, av: r.av, a_: r.a_}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aD: $elm$http$Http$emptyBody, aH: r.aH, Z: _List_Nil, aN: 'GET', aX: $elm$core$Maybe$Nothing, av: $elm$core$Maybe$Nothing, a_: r.a_});
};
...
var $author$project$Commands$cat = F4(
	function (fileSystem, gotImage, args, model) {
		var output = A2(
			...
			A2(
				$elm$core$List$map,
				function (path) {
					var _v0 = A2($author$project$FS$resolvePath, model.j + ('/' + path), fileSystem);
					if (_v0.$ === 1) {
			...
			$elm$http$Http$get(
				{
					aH: A2(
						...
						function (res) {
							return gotImage(
								A2($elm$core$Result$withDefault, 'https://placehold.co/300x200?text=:3', res));
						},
						A2(
							$elm$json$Json$Decode$index,
							0,
							A2($elm$json$Json$Decode$field, 'url', $elm$json$Json$Decode$string))),
					a_: 'https://api.thecatapi.com/v1/images/search'
				})) : _Utils_Tuple2(
			_Utils_update(
				model,
				{a: output}),
...
var $author$project$Commands$cd = F3(
	function (fileSystem, args, model) {
		var _v0 = function () {
			if (!args.b) {
				return _Utils_Tuple2('/', model.a);
			} else {
				var path = args.a;
				var newPath = A2($elm$core$String$startsWith, '/', path) ? path : (model.j + ('/' + path));
				var _v2 = A2($author$project$FS$resolvePath, newPath, fileSystem);
				if (_v2.$ === 1) {
					return _Utils_Tuple2(
						model.j,
						A2(
...
var $author$project$Commands$clear = F2(
	function (_v0, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
	...
	switch (node.$) {
		case 0:
			...
			return $author$project$Ports$download(
				{
					U: $author$project$RichText$toString(content),
					ac: 'text/plain',
					ae: name_
				});
		case 1:
...
var $author$project$Commands$echo = F2(
	function (args, model) {
		var output = A2(
			$elm$core$List$append,
			model.a,
...
var $author$project$RichText$Bold = {$: 1};
...
var $author$project$Main$data = {
	Q: $author$project$RichText$Group(
		_List_fromArray(
			[
				$author$project$RichText$Line(
	...
	T: $author$project$RichText$Group(
		_List_fromArray(
			[
				$author$project$RichText$Line(
	...
	J: _List_fromArray(
		[
			{
			m: $author$project$RichText$Plain('Statically typed, lazily-evaluated functional programming language with Hindley-Milner type inference. Inspired by Haskell and Rust.'),
			q: $author$project$RichText$Plain('Rust'),
			ae: $author$project$RichText$Plain('void-lang'),
			t: $author$project$RichText$Plain('https://github.com/amedoeyes/void-lang')
		},
			{
			m: $author$project$RichText$Plain('Command-line tool to manage external development tools like LSP servers, debuggers, linters, and formatters.'),
			q: $author$project$RichText$Plain('Go'),
			ae: $author$project$RichText$Plain('mason'),
			t: $author$project$RichText$Plain('https://github.com/amedoeyes/mason')
		},
			{
			m: $author$project$RichText$Plain('Command-line tool to interact with MPRIS compatible media players.'),
			q: $author$project$RichText$Plain('Rust'),
			ae: $author$project$RichText$Plain('mprisctl'),
			t: $author$project$RichText$Plain('https://github.com/amedoeyes/mprisctl')
		},
			{
			m: $author$project$RichText$Plain('Cross platform C++23 game engine.'),
			q: $author$project$RichText$Plain('C++'),
			ae: $author$project$RichText$Plain('void-engine'),
			t: $author$project$RichText$Plain('https://github.com/amedoeyes/void-engine')
		},
			{
			m: $author$project$RichText$Plain('Simple modern C++23 command-line interface library.'),
			q: $author$project$RichText$Plain('C++'),
			ae: $author$project$RichText$Plain('cli'),
			t: $author$project$RichText$Plain('https://github.com/amedoeyes/cli')
		},
			{
			m: $author$project$RichText$Plain('Modular modern C++23 lexer library.'),
			q: $author$project$RichText$Plain('C++'),
			ae: $author$project$RichText$Plain('lexer'),
			t: $author$project$RichText$Plain('https://github.com/amedoeyes/lexer')
		},
			{
			m: $author$project$RichText$Plain('This protofolio.'),
			q: $author$project$RichText$Plain('Elm'),
			ae: $author$project$RichText$Plain('portofolio'),
			t: $author$project$RichText$Plain('https://github.com/amedoeyes/amedoeyes.github.io')
		}
		])
};
...
var $author$project$Main$fileSystem = A2(
	...
	_List_fromArray(
		[
			A2($author$project$FS$File, 'about.txt', $author$project$Main$data.Q),
			A2($author$project$FS$File, 'contact.txt', $author$project$Main$data.T),
			A2(
				...
				var maxLen = A2(
					...
					$elm$core$List$maximum(
						A2(
							$elm$core$List$map,
							function (p) {
								return $author$project$RichText$length(p.ae);
							},
							$author$project$Main$data.J)));
									...
									_List_fromArray(
										[
											...
											A2(
												...
												(maxLen - $author$project$RichText$length(p.ae)) + 2,
												' ')),
											p.m
										])));
						},
			...
			A2(
				...
				function (p) {
					return A2(
						$author$project$FS$File,
						$author$project$RichText$toString(p.ae) + '.txt',
						$author$project$RichText$Group(
							_List_fromArray(
								[
									$author$project$RichText$Line(
...
var $author$project$Commands$help = F2(
	function (args, model) {
		var commands = _List_fromArray(
			[
				_Utils_Tuple3('echo', '[ARGS]...', 'display a line of text'),
									...
									$author$project$RichText$Group(
										_List_fromArray(
											[
												...
												A2(
													$elm$core$String$repeat,
													maxLen - (($elm$core$String$length(name) + $elm$core$String$length(_arguments)) + 1),
													' ') + ('  ' + description))
											]))));
						},
						commands));
...
var $author$project$Commands$ls = F3(
	function (fileSystem, args, model) {
		var aux = function (path) {
			var _v1 = A2($author$project$FS$resolvePath, path, fileSystem);
			if (_v1.$ === 1) {
				return $author$project$RichText$Line(
					$author$project$RichText$Plain(
						A2(
							...
							' ',
							_List_fromArray(
								['Error:', '\'' + (model.j + '\''), 'no such file or directory']))));
			} else {
				var node = _v1.a;
				return $author$project$FS$list(node);
			}
		};
		var output = function () {
			if (!args.b) {
				...
				if (!args.b.b) {
					...
					return A2(
						...
						A2(
							$elm$core$List$map,
							function (l) {
								return $author$project$IO$Text(l);
							},
							A2(
								$elm$core$List$intersperse,
								$author$project$RichText$Line(
									...
									function (p) {
										return $author$project$RichText$Group(
											_List_fromArray(
												[
													$author$project$RichText$Line(
													$author$project$RichText$Plain(p + ':')),
													aux(p)
												]));
									},
									paths))));
	...
	function (_v0, model) {
		var output = A2(
			...
			$elm$core$List$singleton(
				$author$project$IO$Text(
					$author$project$RichText$Line(
						$author$project$RichText$Plain(model.j)))));
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{a: output}),
...
var $author$project$FS$tree = function (root) {
	var aux = F4(
		function (node, depth, ancestors, isLast) {
			...
			var line = $author$project$RichText$Line(
				$author$project$RichText$Plain(
					_Utils_ap(
						prefix,
						_Utils_ap(
	...
	return $author$project$RichText$Group(
		A4(aux, root, 0, _List_Nil, false));
};
var $author$project$Commands$tree = F3(
	function (fileSystem, args, model) {
		var aux = function (path) {
			var _v1 = A2($author$project$FS$resolvePath, path, fileSystem);
			if (_v1.$ === 1) {
					...
					return A2(
						...
						A2(
							...
							A2(
								...
								$author$project$RichText$Line(
									$author$project$RichText$Plain('')),
								A2($elm$core$List$map, aux, paths))));
				}
			}
		}();
		return _Utils_Tuple2(
...
var $author$project$Main$commands = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('echo', $author$project$Commands$echo),
			_Utils_Tuple2('clear', $author$project$Commands$clear),
			_Utils_Tuple2('pwd', $author$project$Commands$pwd),
			_Utils_Tuple2(
			'cd',
			$author$project$Commands$cd($author$project$Main$fileSystem)),
			_Utils_Tuple2(
			'ls',
			$author$project$Commands$ls($author$project$Main$fileSystem)),
			_Utils_Tuple2(
			'tree',
			$author$project$Commands$tree($author$project$Main$fileSystem)),
			_Utils_Tuple2(
			'cat',
...
var $author$project$Main$scrollToBottom = A2(
	...
	A2($elm$browser$Browser$Dom$setViewport, 0.0, 1.0e9));
										...
										$author$project$RichText$Group(
											_List_fromArray(
												[
													...
													$author$project$RichText$Plain(model.aM)
												]))))
								]))
					});
				var _v1 = $elm$core$String$words(model.aM);
				if (!_v1.b) {
					return _Utils_Tuple2(model_, $elm$core$Platform$Cmd$none);
				} else {
					var name = _v1.a;
					var args = _v1.b;
					var _v2 = A2($elm$core$Dict$get, name, $author$project$Main$commands);
					if (!_v2.$) {
						var cmd = _v2.a;
						return function (_v3) {
							var m = _v3.a;
							...
							return _Utils_Tuple2(
								...
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[c, $author$project$Main$scrollToBottom])));
						}(
							A2(cmd, args, model_));
					} else {
						return (name === '') ? _Utils_Tuple2(model_, $author$project$Main$scrollToBottom) : _Utils_Tuple2(
							_Utils_update(
								model_,
								{
									a: _Utils_ap(
			...
			case 2:
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$Task$attempt,
						$elm$core$Basics$always($author$project$Main$NoOp),
						$elm$browser$Browser$Dom$focus('shell-line-input')));
			case 3:
				var url = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$ProcessInput = {$: 1};
...
var $author$project$RichText$view = function (richText) {
	switch (richText.$) {
		case 0:
			var str = richText.a;
			return _List_fromArray(
				...
				[
					...
					A2(
						...
						function (s) {
							if (!s.$) {
								var c = s.a;
								return A2($elm$html$Html$Attributes$style, 'color', c);
							} else {
								return A2($elm$html$Html$Attributes$style, 'font-weight', 'bold');
							}
						},
						styles),
					$author$project$RichText$view(rt))
				]);
		case 2:
			var rt = richText.a;
			return _List_fromArray(
		...
		default:
			var rts = richText.a;
			return A2($elm$core$List$concatMap, $author$project$RichText$view, rts);
	}
};
var $author$project$IO$viewInput = F4(
	function (prompt, onInput, onEnter, model) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('shell-line')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('shell-line-prompt')
						]),
					$author$project$RichText$view(prompt)),
					A2(
					$elm$html$Html$textarea,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$id('shell-line-input'),
...
var $author$project$IO$viewOutput = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(
			...
			function (o) {
				if (!o.$) {
					var rt = o.a;
					return $author$project$RichText$view(rt);
				} else {
					var u = o.a;
					return _List_fromArray(
						[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$IO$viewOutput(model),
				A4(
				$author$project$IO$viewInput,
				$author$project$Main$prompt,
				...
				A2(
					...
					A2(
						$elm$json$Json$Decode$map,
						function (key) {
							return (key === 'Enter') ? _Utils_Tuple2($author$project$Main$ProcessInput, true) : _Utils_Tuple2($author$project$Main$NoOp, false);
						},
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{aL: $author$project$Main$init, aW: $author$project$Main$subscriptions, aZ: $author$project$Main$update, a$: $author$project$Main$view});
