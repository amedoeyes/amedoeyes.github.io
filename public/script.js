...
var $author$project$Main$FocusPrompt = {$: 'FocusPrompt'};
...
var $author$project$Main$onKeyPressFocus = $elm$browser$Browser$Events$onKeyPress(
	A3(
		...
		F2(
			function (ctrl, meta) {
				return (ctrl || meta) ? $author$project$Main$NoOp : $author$project$Main$FocusPrompt;
			}),
...
var $author$project$Main$prompt = '$ ';
		...
		switch (msg.$) {
			...
			case 'Submit':
				var _v1 = A2(
					...
					$elm$core$String$words(model.prompt));
				var newModel = _v1.a;
				var newCmd = _v1.b;
				return _Utils_Tuple2(
					newModel,
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[newCmd, $author$project$Main$scrollToBottom])));
			case 'FocusPrompt':
				return _Utils_Tuple2(
					model,
					A2(
			...
			function (o) {
				if (o.$ === 'Text') {
					...
					return A2(
						$elm$html$Html$div,
						_List_Nil,
						A2($elm$core$List$map, $author$project$Main$viewText, ts));
				} else {
					var u = o.a;
					return A2(
						$elm$html$Html$img,
